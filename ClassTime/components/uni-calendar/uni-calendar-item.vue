...
<style lang="scss" scoped>
	...
	.uni-calendar-item__weeks-box-red-circle {
		border-radius: 50px;
		background-color: red;//$uni-color-error;
	}

	.uni-calendar-item__weeks-box-circle {
		border-radius: 50px;
		background-color: green;//$uni-color-error;
	}
	.uni-calendar-item__weeks-box-circle .uni-calendar-item__weeks-box-text,.uni-calendar-item__weeks-box-red-circle .uni-calendar-item__weeks-box-text{
		color:#fff;
	}
